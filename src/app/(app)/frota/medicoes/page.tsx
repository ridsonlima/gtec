...
export default async function FrotaMedicoesPage({ searchParams }: { searchParams: SP }) {
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Faturamento mensal de veículos — Frota CDG RENTAL</p>
        </div>
        {canGestor && (
          <Link href="/frota/medicoes/nova" className="inline-flex items-center gap-1.5 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors">
      ...
      {medicoes.length === 0 ? (
        <div className="bg-white rounded-xl border border-dashed border-gray-200 p-12 text-center">
          ...
          {canGestor && <Link href="/frota/medicoes/nova" className="text-sm text-blue-600 hover:underline mt-2 inline-block">Criar primeira medição →</Link>}
        </div>
      ) : (
