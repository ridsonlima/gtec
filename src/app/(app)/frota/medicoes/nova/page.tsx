...
export default function FrotaNovaMedicaoPage() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      ...
      router.push(`/frota/medicoes/${data.data.id}`)
  ...
  return (
    <div className="max-w-xl space-y-5">
      ...
      <div className="flex items-center gap-3">
        <Link href="/frota/medicoes" className="p-1.5 rounded-lg bg-white border border-gray-200 hover:border-gray-400 transition-colors">
      ...
      <form onSubmit={submit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-5">
        ...
        <div className="flex justify-end gap-3 pt-2 border-t border-gray-100">
          <Link href="/frota/medicoes" className="px-4 py-2 text-sm text-gray-600">Cancelar</Link>
          <button
            type="submit"
            disabled={saving}
