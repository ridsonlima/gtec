...
export default async function FrotaManutencaoPage({ searchParams }: { searchParams: SP }) {
  ...
  const where: any = { ativo: { tipo: 'veiculo' } }
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">OS de veículos — Frota CDG RENTAL</p>
        </div>
        {canGestor && <NovaOSListModal moduloTipo="veiculo" />}
      </div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-medium text-gray-900">
                    <Link href={`/frota/ativos/${os.ativo.id}`} className="hover:underline">{os.ativo.tag}</Link>
                    {' '}<span className="font-normal text-gray-500">·</span>{' '}
                    <Link href={`/frota/manutencao/${os.id}`} className="font-normal text-gray-700 hover:text-blue-600 hover:underline">
                      {os.descricao}
                    </Link>
                  </p>
                ...
                <div className="flex-shrink-0 flex flex-col items-end gap-2">
                  ...
                  <Link href={`/frota/manutencao/${os.id}`} className="text-gray-300 hover:text-blue-500 transition-colors" title="Ver detalhes">
