...
export default async function FrotaPendenciaDetalhePage({ params }: { params: { id: string } }) {
  ...
  if (!pendencia) redirect('/frota/auditorias/pendencias')
    ...
    <div className="max-w-2xl space-y-5">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-3">
          <Link href="/frota/auditorias/pendencias" className="mt-1 p-1.5 rounded-lg bg-white border border-gray-200 hover:border-gray-400 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="space-y-4">
          ...
          {pendencia.item && (
            <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-3">
              ...
              <div>
                ...
                <Link href={`/frota/ativos/${pendencia.item.ativo.id}`} className="text-sm font-medium text-blue-600 hover:underline">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-3">
            ...
            <Link href={`/frota/auditorias/${pendencia.visitaId}`} className="text-xs text-blue-600 hover:underline">
              Ver auditoria →
            </Link>
          </div>
        </div>
